...
- Immich - should have right click functionality to open alt menu of the app instead of browser alt menu.
- Immich - could have an easier way to access download button. 
