**Name:** Christine, the Programmer

**Age:** 22

**Occupation/Function:** Student, Personal Project Enthusiast

**Tech level:** 9/10

**Screening question:**<br>
"Do you need a server to host web applications or multiplayer online games for personal or business use?"

**Description** <br>
Christine is a computer science student in her last year and is very enthusiastic to build her own personal projects. Lately she has been interested in building apps which connect multiple users, not just pieces of code which are run locally on a single computer. She wants to build a portfolio website which can be accessed by anyone. She also has an interest in moving from making offline games to multiplayer games, which can be played by 2 or more people, which are on different computers. <br>
In both cases she has encountered the issue of needing a server to host.

**Problem** <br>
There are organizations which offer hosting servers for other people to run, but not at a cheap price if considered over a longer period of time. 
